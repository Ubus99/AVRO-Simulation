...
namespace Dreamteck.Splines
{
    public partial class SplineMesh : MeshGenerator
    {
        ...
        public class Channel
        {
            ...
            [SerializeField]
            [HideInInspector]
            List<MeshDefinition> meshes = new();
            ...
            FloatHandler _extrudeRotationHandler;
            Vector2Handler _offsetHandler;

            Random _offsetRandom;
            QuaternionHandler _placeRotationHandler;

            Random _rotationRandom;
            Vector3Handler _scaleHandler;
            ...
            {
                if (_randomOffset)
                    return new Vector2(Mathf.Lerp(_minOffset.x, _maxOffset.x, (float)_offsetRandom.NextDouble()),
            ...
            public Vector3 NextRandomScale()
            {
                if (_randomScale)
                {
                    ...
                    return new Vector3(Mathf.Lerp(_minScale.x, _maxScale.x, (float)_scaleRandom.NextDouble()),
            ...
            public class MeshDefinition
            {
                ...
                {
                    get { return _vertexGroupingMargin; }
                    set
                    {
