...
namespace Dreamteck.Splines.Editor
{
    public class BakeTool : SplineTool
    {
        ...
        List<MeshGenerator> excluded = new();
        ...
        List<MeshGenerator> selected = new();
        ...
        public override void Draw(Rect windowRect)
        {
            ...
            var saveMesh = format != BakeMeshWindow.SaveFormat.Scene;

            if (format != BakeMeshWindow.SaveFormat.Scene)
            {
                copy = EditorGUILayout.Toggle("Save without baking", copy);
            }
            var isCopy = format != BakeMeshWindow.SaveFormat.Scene && copy;
            switch (format)
            {
